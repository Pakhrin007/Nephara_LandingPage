...
import testimonials from "../constants/landing-page-testinomial/index"
...
const LandingPage = () => {
  return (
    ...
    <div className="flex w-full flex-col gap-y-[26px] max-w-[1280px] mx-auto" >
    <div className="flex flex-col gap-y-2">
      <h1 className="font-title font-medium tracking-wide text-[20px] text-blue-300">Designed for flexibility</h1>
      <p className="text-gray-500 text-base text-[30px] font-title">Make pen work for you.</p>
      </div>
      <Sidebar />
