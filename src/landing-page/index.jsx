...
const LandingPage = () => {
  return (
    <div className="flex flex-col gap-y-8 bg-gray-50 min-h-screen">
      <Navbar />
      <HeroSection
      ...
      <div className="flex flex-col items-center py-12 px-4 max-w-[1280px] mx-auto">
        <div className="flex flex-col gap-y-6 w-full">
          <h1 className="text-xl font-sans font-bold tracking-wide text-blue-300">
            Designed for Collaboration
          </h1>
          <p className="text-2xl font-sans text-gray-900 leading-relaxed text-center">
      ...
      <div className="flex flex-col gap-y-12 px-4 max-w-[1280px] mx-auto">
        <div className="flex flex-col gap-y-4">
          ...
          <h2 className="text-xl font-sans font-medium">Discuss, review, and get things done with your team.</h2>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="flex-1 flex flex-col gap-y-4">
            ...
            <p className="text-lg font-sans font-medium">Discuss, review, and get things done with your team.</p>
            <p className="text-gray-500 text-lg font-sans leading-normal">
              Easily help one another with information and context, before the email is sent.
            </p>
      ...
      <div className="flex flex-col gap-y-12 bg-gray-100 py-6 w-full mx-auto">
        <div className="flex flex-col gap-y-2 md:ml-64 px-4 max-w-[1280px] ">
          <h1 className="text-3xl font-sans font-medium text-blue-300">
            Designed for Collaboration
          </h1>
      ...
      <div className="flex flex-col gap-y-6 py-2 max-w-[1280px] w-full mx-auto ">
