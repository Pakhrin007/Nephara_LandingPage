...
import projectmanagement from "../../../../assets/video/project-managemenet.mp4"
const ProjectManagement = () => {
  return (
    <div className="flex flex-col gap-y-[24px]">
      ...
      <HeroSection
        title="Project Management for Smarter Decision Making"
        description="Leverage project management to analyze emails, extract key points, and boost your team's productivity effortlessly."
        video={projectmanagement}
      />
      <InfiniteScroll />
      ...
      <div className="flex flex-col gap-y-6 w-full ">
        ...
        <p className=" text-[46px] font-title leading-[45px] text-justify">
          See what’s going on and project management behind the scenes - without changing your workflow.
        </p>
    ...
    <div className="flex w-full flex-col gap-y-[26px] max-w-[1280px] mx-auto">
      ...
      <video src={projectmanagement} autoPlay loop muted className="w-full h-full object-cover"></video>
      </div>
