...
import documentTestimonials from '../../../../constants/document-testimonial/index';
const Documents = () => {
  return (
    <div className="flex flex-col gap-y-[24px]">
      ...
      <HeroSection
        title="Documents for Smarter Decision Making"
        description="Leverage documents to analyze emails, extract key points, and boost your team's productivity effortlessly."
        video={video}
      />
      <InfiniteScroll />
      ...
      <div className="flex flex-col gap-y-6 w-full ">
        ...
        <p className=" text-[46px] font-title leading-[45px] text-justify">
          See what’s going on and documents behind the scenes - without changing your workflow.
        </p>
    ...
    <div className="flex flex-col gap-y-2">
      ...
      <Testimonial testimonials={documentTestimonials} />
      <CTASection />
    </div>
  );
};
