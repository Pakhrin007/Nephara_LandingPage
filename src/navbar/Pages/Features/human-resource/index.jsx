...
import humanResourceTestimonials from '../../../../constants/human-resource-testimonial/index';
  ...
  return (
    <div className="flex flex-col gap-y-[24px]">
      ...
      <HeroSection
        title="Human Resource for Smarter Decision Making"
        description="Leverage human resource to analyze emails, extract key points, and boost your team's productivity effortlessly."
        video={video}
      />
      <InfiniteScroll />
      ...
      <div className="flex flex-col gap-y-6 w-full ">
        <h1 className="text-[20px] font-title font-bold tracking-wide text-blue-300  ">
            Designed for Human Resource
        </h1>
        <p className=" text-[46px] font-title leading-[45px] text-justify">
          See what’s going on and human resource behind the scenes - without changing your workflow.
        </p>
